...
# 정적 sitemap 생성
echo "Start create static sitemap "
node ./sitemap-common.js
echo "Start create static sitemap Done"
...
# sitemap 압축 및 병합
echo "Start sitemap gzip"
node ./sitemap-compress.js
node ./sitemap.js
echo "Start sitemap gzip Done"

# Google 서치콘솔에 sitemap 업데이트 핑 전송
# curl http://google.com/ping?sitemap=https://www.rest-hub.com/sitemap.xml
